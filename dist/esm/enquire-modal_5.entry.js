...
let NavBarV2 = class {
  ...
  render() {
    return (h(Host, null, h("div", { class: "container" }, h("div", { class: "menu" }, h("div", { class: "logo" }, h("img", { src: getAssetPath('./assets/leibal-logo.png'), alt: "logo", onClick: () => {
      ...
      }, type: "text", placeholder: "Start Typing..." })))), h("div", { class: `menu submenu ${this.currentMenu == 'read' && 'submenu--open'}` }, h("div", null), h("div", { class: "sub-link" }, h("a", { href: this.platformSpecificLink('blog', '/') }, "Read All")), h("div", { class: "sub-link" }, h("a", { href: this.platformSpecificLink('blog', '/category/architecture') }, "Architecture")), h("div", { class: "sub-link" }, h("a", { href: this.platformSpecificLink('blog', '/category/interiors') }, "Interiors")), h("div", { class: "sub-link" }, h("a", { href: this.platformSpecificLink('blog', '/category/furniture') }, "Furniture")), h("div", { class: "sub-link" }, h("a", { href: this.platformSpecificLink('blog', '/category/lighting') }, "Lighting")), h("div", { class: "sub-link" }, h("a", { href: this.platformSpecificLink('blog', '/category/objects') }, "Objects")), h("div", { class: "sub-link" }, h("a", { href: this.platformSpecificLink('blog', '/category/travel') }, "Travel")), h("div", { class: "sub-link inactive" }, h("a", { href: "#" }, "City Guides")), h("div", null)), h("div", { class: `menu submenu ${this.currentMenu == 'shop' && 'submenu--open'}` }, h("div", null), h("div", { class: "sub-link" }, h("a", { href: this.platformSpecificLink('store', '/collections/all') }, "Shop All")), h("div", { class: "sub-link" }, h("a", { href: this.platformSpecificLink('store', '/collections/seating') }, "Seating")), h("div", { class: "sub-link" }, h("a", { href: this.platformSpecificLink('store', '/collections/tables') }, "Tables")), h("div", { class: "sub-link" }, h("a", { href: this.platformSpecificLink('store', '/collections/lighting') }, "Lighting")), h("div", { class: "sub-link" }, h("a", { href: this.platformSpecificLink('store', '/collections/storage') }, "Storage")), h("div", { class: "sub-link" }, h("a", { href: this.platformSpecificLink('store', '/collections/outdoor') }, "Outdoor")), h("div", { class: "sub-link" }, h("a", { href: this.platformSpecificLink('store', '/collections/accessories') }, "Accessories")), h("div", { class: "sub-link" }, h("a", { href: this.platformSpecificLink('store', '/collections/brands') }, "Brands")), h("div", null)))));
  }
};
