...
const moodsBoardCss = ":host{display:block}.moods-board{cursor:default;display:block;font-size:.88rem}@media (min-width:768px){.moods-board{display:grid;gap:1rem;grid-template-columns:repeat(10,minmax(0,1fr))}.moods-board__sidebar{grid-column:span 2/span 2}}.moods-board__contents{display:block;gap:2rem}@media (min-width:768px){.moods-board__contents{display:grid;grid-column:span 8/span 8;grid-template-columns:repeat(4,minmax(0,1fr))}}.moods-board__content{cursor:pointer;margin-bottom:4rem}.moods-board__content__image{width:100%}.moods-board__content__title{font-size:.6rem;margin-bottom:.25rem;margin-top:1rem;text-transform:uppercase}.moods-board__content__subtitle{font-size:.6rem;font-weight:300;text-transform:uppercase}.moods-board__create-board{cursor:pointer;margin-bottom:.5rem;padding-bottom:.5rem;padding-top:.5rem}.moods-board__create-board:hover{font-weight:700;text-decoration-line:underline;text-underline-offset:2px}.moods-board__sort__header{margin-bottom:.5rem}.moods-board__sort-by{cursor:pointer;margin-bottom:.5rem;margin-left:1.5rem}.moods-board__sort-by--selected{font-weight:700;text-decoration-line:underline;text-underline-offset:2px}";
