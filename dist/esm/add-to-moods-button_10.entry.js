...
let FooterNav = class {
  ...
  render() {
    ...
    return (h(Host, null, h("div", { class: "footer-nav" }, h("div", { class: "footer-nav__column" }, h("div", { class: "footer-nav__title" }, "Stories"), h("div", { class: "footer-nav__links" }, h("a", { class: "footer-nav__link", href: this.platformSpecificLink('blog', '/category/architecture') }, "Architecture"), h("a", { class: "footer-nav__link", href: this.platformSpecificLink('blog', '/category/interiors') }, "Interiors"), h("a", { class: "footer-nav__link", href: this.platformSpecificLink('blog', '/category/furniture') }, "Furniture"), h("a", { class: "footer-nav__link", href: this.platformSpecificLink('blog', '/category/lighting') }, "Lighting"), h("a", { class: "footer-nav__link", href: this.platformSpecificLink('blog', '/category/products') }, "Products"), h("a", { class: "footer-nav__link", href: this.platformSpecificLink('blog', '/category/travel') }, "Travel"))), h("div", { class: "footer-nav__column" }, h("div", { class: "footer-nav__title" }, "Store"), h("div", { class: "footer-nav__links" }, h("a", { class: "footer-nav__link", href: this.platformSpecificLink('store', '/collection/seating') }, "Seating"), h("a", { class: "footer-nav__link", href: this.platformSpecificLink('store', '/collection/tables') }, "Tables"), h("a", { class: "footer-nav__link", href: this.platformSpecificLink('store', '/collection/lighting') }, "Lighting"), h("a", { class: "footer-nav__link", href: this.platformSpecificLink('store', '/collection/storage') }, "Storage"), h("a", { class: "footer-nav__link", href: this.platformSpecificLink('store', '/collection/outdoor') }, "Outdoor"), h("a", { class: "footer-nav__link", href: this.platformSpecificLink('store', '/collection/accessories') }, "Accessories"))), h("div", { class: "footer-nav__column" }, h("div", { class: "footer-nav__title" }, "About"), h("div", { class: "footer-nav__links" }, h("a", { class: "footer-nav__link", href: this.platformSpecificLink('blog', '/contact-us') }, "Contact Us"), h("a", { class: "footer-nav__link", href: this.platformSpecificLink('blog', '/submissions-form') }, "Submit"), h("a", { class: "footer-nav__link", href: this.platformSpecificLink('blog', '/faq') }, "FAQ"), h("a", { class: "footer-nav__link", href: this.platformSpecificLink('blog', '/privacy') }, "Privacy"), h("a", { class: "footer-nav__link", href: this.platformSpecificLink('blog', '/terms-and-conditions') }, "Terms & Conditions"), h("a", { class: "footer-nav__link", href: this.platformSpecificLink('blog', '/trades') }, "Trade Program"))), h("div", { class: "footer-nav__column" }, h("div", { class: "footer-nav__title" }, "Connect"), h("div", { class: "footer-nav__links" }, h("a", { class: "footer-nav__link", href: "https://www.pinterest.com/leibal/" }, "Pinterest"), h("a", { class: "footer-nav__link", href: "https://instagram.com/leibal" }, "Instagram"), h("a", { class: "footer-nav__link", href: "http://www.facebook.com/Leibal" }, "Facebook"), h("a", { class: "footer-nav__link", href: "https://leibal.tumblr.com/" }, "Tumblr"), h("a", { class: "footer-nav__link", href: "https://www.linkedin.com/company/leibal/" }, "LinkedIn"), h("a", { class: "footer-nav__link", href: "https://www.tiktok.com/leibal" }, "TikTok"))), h("div", { class: "footer-nav__column" }, h("div", { class: "footer-nav__title" }, "Newsletter"), h("div", { class: "footer-nav__email-form" }, this.platform === 'blog' ? blogNewsletterForm : storeNewsletterForm), h("div", { class: "footer-nav__trademark" }, "\u00A9 ", new Date().getUTCFullYear(), " LEIBAL LLC. ALL RIGHTS RESERVED")))));
  }
};
