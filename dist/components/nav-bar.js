...
let NavBar$1 = class extends HTMLElement {
  ...
  render() {
    return (h(Host, null, h("div", { style: { height: (this.scrolled ? this.currentHeight : 0) + 'px' } }), h("nav", { class: 'navbar ' + (this.scrolled ? 'navbar--scrolled ' : '') + (this.scrolledUp ? 'show' : '') }, h("div", { class: "navbar__row" }, h("a", { href: this.platformSpecificLink('blog', '/'), class: 'navbar__row__leading navbar__row__leading__logo ' + (this.platform === 'blog' ? 'font-bold' : '') }, h("div", { class: "navbar__logo" }, h("img", { src: getAssetPath(`./assets/leibal-logo.png`) })), h("a", { href: "/" }, "Stories")), h("div", { class: "navbar__row__links" }, h("a", { href: this.platformSpecificLink('blog', '/category/architecture') }, "Architecture"), h("a", { href: this.platformSpecificLink('blog', '/category/interiors') }, "Interiors"), h("a", { href: this.platformSpecificLink('blog', '/category/furniture') }, "Furniture"), h("a", { href: this.platformSpecificLink('blog', '/category/lighting') }, "Lighting"), h("a", { href: this.platformSpecificLink('blog', '/category/products') }, "Objects"), h("a", { href: this.platformSpecificLink('blog', '/category/travel') }, "Travel")), h("div", { class: "navbar__row__action" }, h("a", { href: "/submissions" }, "Submit"), this.authenticated ? (h("a", { href: this.platformSpecificLink('blog', '/moods'), class: "navbar__moods-logo" }, h("img", { src: getAssetPath(`./assets/moods-white.png`) }))) : (h("a", { href: this.platformSpecificLink('blog', '/subscription/subscribe') }, "Sign Up")))), h("div", { class: "navbar__row" }, h("div", { class: 'navbar__search ' + (this.showSearch ? 'navbar__search--visible' : '') }, h("input", { ref: el => (this.searchInput = el), class: "navbar__search__input", onInput: e => {
      ...
      }, type: "text", placeholder: "Start Typing..." })), h("a", { href: this.platformSpecificLink('store', '/'), class: 'navbar__row__leading ' + (this.platform === 'store' ? 'font-bold' : '') }, h("div", { class: "navbar__logo", style: { opacity: '0', visibility: 'hidden' } }, h("img", { src: getAssetPath(`./assets/leibal-logo.png`) })), "Store"), h("div", { class: "navbar__row__links" }, h("a", { href: this.platformSpecificLink('store', '/collections/seating') }, "Seating"), h("a", { href: this.platformSpecificLink('store', '/collections/tables') }, "Tables"), h("a", { href: this.platformSpecificLink('store', '/collections/lighting') }, "Lighting"), h("a", { href: this.platformSpecificLink('store', '/collections/storage') }, "Storage"), h("a", { href: this.platformSpecificLink('store', '/collections/outdoor') }, "Outdoor"), h("a", { href: this.platformSpecificLink('store', '/collections/accessories') }, "Accessories")), h("div", { class: "navbar__row__action" }, h("a", { href: "/cart", class: "border-l border-white cursor-pointer" }, "Cart"), h("a", { class: "z-10 cursor-pointer", onClick: () => {
