...
import { d as defineCustomElement$1 } from './simple-button2.js';
...
let MoodsBoardPicker = class extends HTMLElement {
  ...
  static get style() { return moodsBoardPickerCss; }
};
MoodsBoardPicker = /*@__PURE__*/ proxyCustomElement(MoodsBoardPicker, [1, "moods-board-picker", {
    "boards": [1537],
    "selectedMoodBoard": [1040],
    "open": [32],
    "moodBoards": [32],
    "inputValue": [32],
    "newBoardName": [32]
...
function defineCustomElement() {
  ...
  const components = ["moods-board-picker", "simple-button"];
  components.forEach(tagName => { switch (tagName) {
    case "moods-board-picker":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, MoodsBoardPicker);
      }
      break;
    case "simple-button":
      if (!customElements.get(tagName)) {
...
export { MoodsBoardPicker as M, defineCustomElement as d };
