...
import { d as defineCustomElement$7 } from './add-to-moods-button2.js';
import { d as defineCustomElement$6 } from './display-card2.js';
import { d as defineCustomElement$5 } from './enquire-modal2.js';
import { d as defineCustomElement$4 } from './simple-button2.js';
import { d as defineCustomElement$3 } from './simple-input2.js';
...
let ImageGallery$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.images = '[]';
  ...
  render() {
    ...
    return (h(Host, null, h("tele-portal", null, h("div", { class: this.isModalOpen ? 'image-gallery image-gallery--visible' : 'image-gallery' }, h("div", { class: "image-gallery__info" }, h("div", { onClick: () => {
        this.isModalOpen = false;
      }, style: { position: 'relative' } }, h("div", { class: "image-gallery__info__title" }, this.postTitle), h("div", { class: "image-gallery__info__subtitle" }, "by ", this.postExcerpt), h("div", { class: "image-gallery__info__photographer__label" }, "Photography"), h("div", { class: "flex justify-between items-center image-gallery__info__photographer__title" }, h("div", null, this._images[this.currentImageIndex] === undefined
      ? this._images[this.currentImageIndex].photographer
      : this.photographer), h("div", { class: "lg:hidden" }, h("add-to-moods-button", { theme: 'dark', "image-url": this._images[this.currentImageIndex].href, "post-id": this.postId, "content-location": 'left' }, h("span", { style: { marginRight: '0.5rem', fontSize: '0.5rem' } }, "Save Image to MOODS")))), h("div", { class: "swiper-pagination" })), h("div", { class: "hidden lg:block" }, h("add-to-moods-button", { theme: 'dark', "image-url": this._images[this.currentImageIndex].href, "post-id": this.postId, "content-location": 'right', style: { marginTop: '2.5rem' } }, h("span", { style: { marginLeft: '1rem', fontSize: '0.75rem' } }, "Save Image to MOODS"))), h("div", null, this.canEnquire && (h("div", { class: "hidden lg:block" }, h("enquire-modal", { postTitle: this.postTitle + ' by ' + this.postExcerpt, previewImage: this.previewImage }))), this.canBook && (h("div", null, h("div", { class: "block xl:grid xl:grid-cols-12 xl:gap-8 design-detail" }, h("a", { href: this.bookUrl, class: "block col-span-8", target: "_blank", style: { letterSpacing: '1.6px' } }, h("div", { class: "overflow-hidden relative w-full aspect-square" }, h("img", { class: "object-cover object-center w-full h-full", src: this.previewImage }))), h("div", { class: "flex flex-col col-span-4 justify-between mt-4 mb-8 text-[9px] lg:mt-0 xl:mb-0" }, h("div", { class: "uppercase" }, h("div", { class: "font-light" }, "Book"), h("div", { class: "font-normal" }, this.postTitle)), h("div", { class: "font-light" }, "Find out more information regarding availability, pricing, and booking.")), h("a", { href: this.bookUrl, target: "_blank", class: "block col-span-8" }, h("simple-button", null, "Book"))))), !this.canEnquire && designDetail && (h("div", { class: "hidden lg:block" }, h("div", { class: "block xl:grid xl:grid-cols-12 xl:gap-8" }, h("display-card", { images: JSON.stringify([designDetail.image.url]), style: { marginBottom: '0' }, class: "col-span-8" }, h("div", { slot: "top-title", style: {
        fontSize: '0.6rem',
        letterSpacing: '1.6px',
        fontWeight: '400',
      } }, designDetail.designer || 'Unknown'), h("div", { slot: "top-subtitle", style: {
        fontSize: '0.6rem',
        letterSpacing: '1.6px',
        fontWeight: '300',
      } }, designDetail.category || 'N/A'), h("div", { slot: "bottom-title", style: {
        fontSize: '0.88rem',
        letterSpacing: '1.6px',
        fontWeight: '400',
      } }, designDetail.name || ''), h("div", { slot: "bottom-subtitle", style: {
        fontSize: '0.6rem',
        letterSpacing: '1.6px',
        fontWeight: '300',
      } }, designDetail.price || '')), h("div", { class: "flex flex-col col-span-4 mb-8 text-2xs xl:mb-0" }, h("div", null, h("span", null, "As seen in image "), asSeenIns.map((image, i) => {
...
ImageGallery$1 = /*@__PURE__*/ proxyCustomElement(ImageGallery$1, [0, "image-gallery", {
    "images": [1537],
    "postId": [1538, "post-id"],
    "postTitle": [1537, "post-title"],
    "postExcerpt": [1537, "post-excerpt"],
    "previewImage": [1537, "preview-image"],
    "photographer": [1537],
    "canEnquire": [1540, "can-enquire"],
    "designDetail": [1537, "design-detail"],
    "canBook": [1540, "can-book"],
    "bookUrl": [1537, "book-url"],
    "isModalOpen": [32],
    "currentImageIndex": [32]
  }, [[16, "openImageGallery", "openImageGalleryHandler"], [16, "keydown", "keydownHandler"]]]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["image-gallery", "add-to-moods-button", "display-card", "enquire-modal", "simple-button", "simple-input", "tele-portal"];
  components.forEach(tagName => { switch (tagName) {
    case "image-gallery":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ImageGallery$1);
      }
      break;
...
const ImageGallery = ImageGallery$1;
const defineCustomElement = defineCustomElement$1;

export { ImageGallery, defineCustomElement };
