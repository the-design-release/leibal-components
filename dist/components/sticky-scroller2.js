...
let StickyScroller = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.startOffset = 0;
...
StickyScroller = /*@__PURE__*/ proxyCustomElement(StickyScroller, [4, "sticky-scroller", {
    "startOffset": [2, "start-offset"],
    "endOffset": [2, "end-offset"],
    "bottom": [4],
    "mode": [1],
    "argsRef": [32]
  }]);
function defineCustomElement() {
  ...
  const components = ["sticky-scroller"];
  components.forEach(tagName => { switch (tagName) {
    case "sticky-scroller":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, StickyScroller);
      }
      break;
  } });
}

export { StickyScroller as S, defineCustomElement as d };
