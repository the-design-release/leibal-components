...
let TermsOfService$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["terms-of-service", "sticky-scroller"];
  components.forEach(tagName => { switch (tagName) {
    case "terms-of-service":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, TermsOfService$1);
      }
      break;
...
const TermsOfService = TermsOfService$1;
const defineCustomElement = defineCustomElement$1;

export { TermsOfService, defineCustomElement };
