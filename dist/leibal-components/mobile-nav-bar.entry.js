...
const mobileNavBarCss = ":host{display:block}.mobile-nav-bar{position:fixed;top:0px;left:0px;right:0px;z-index:100;font-weight:200}.mobile-nav-bar__icons{position:absolute;z-index:50;display:grid;height:50px;width:100%;grid-template-columns:repeat(6, minmax(0, 1fr));align-items:center;border-bottom-width:1px;--tw-border-opacity:1;border-bottom-color:rgb(209 213 219 / var(--tw-border-opacity));--tw-bg-opacity:1;background-color:rgb(255 255 255 / var(--tw-bg-opacity));transition-property:color, background-color, border-color, text-decoration-color, fill, stroke;transition-duration:300ms;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1);border-bottom-style:solid}.mobile-nav-bar__icons--open{--tw-border-opacity:1;border-bottom-color:rgb(255 255 255 / var(--tw-border-opacity));--tw-bg-opacity:1;background-color:rgb(0 0 0 / var(--tw-bg-opacity));--tw-text-opacity:1;color:rgb(255 255 255 / var(--tw-text-opacity));transition-property:color, background-color, border-color, text-decoration-color, fill, stroke;transition-duration:300ms;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1)}.mobile-nav-bar__icons--open .mobile-nav-bar__icon{filter:invert(1)}.mobile-nav-bar__icon{display:block;width:1rem;cursor:pointer;padding:1rem}.mobile-nav-bar__menu{position:absolute;z-index:40;box-sizing:border-box;display:flex;width:100%;flex-direction:column;justify-content:space-between;--tw-bg-opacity:1;background-color:rgb(0 0 0 / var(--tw-bg-opacity));--tw-text-opacity:1;color:rgb(255 255 255 / var(--tw-text-opacity));visibility:hidden;opacity:0;transition:visibility 0s, opacity 300ms cubic-bezier(0.4, 0, 0.2, 1);height:100vh;padding:2rem 1rem;padding-top:calc(50px + 3.5rem);padding-bottom:calc(50px + 3.5rem)}.mobile-nav-bar__menu--open{visibility:visible;opacity:1}.mobile-nav-bar__logo{margin-bottom:2rem;display:block;width:100px;filter:invert(1)}.mobile-nav-bar__menu-items{margin-bottom:3rem}.mobile-nav-bar__menu-links-container{position:absolute;height:100%;width:100%;visibility:hidden;opacity:0;transition:visibility 0s, opacity 300ms cubic-bezier(0.4, 0, 0.2, 1)}.mobile-nav-bar__menu-links-container--open{visibility:visible;opacity:1;transition:visibility 300ms 0, opacity 300ms cubic-bezier(0.4, 0, 0.2, 1)}.mobile-nav-bar__menu-links{position:absolute;top:0px;right:0px;left:0px;bottom:0px;z-index:60;display:flex;flex-direction:column;--tw-bg-opacity:1;background-color:rgb(0 0 0 / var(--tw-bg-opacity))}.mobile-nav-bar__menu-links a{margin-bottom:0.5rem;font-size:0.88rem;font-weight:200;--tw-text-opacity:1;color:rgb(255 255 255 / var(--tw-text-opacity));text-decoration-line:none}.mobile-nav-bar__menu-links a:hover{text-decoration-line:underline;text-underline-offset:2px}.mobile-nav-bar__menu-item{margin-bottom:0.75rem;font-size:1.125rem;line-height:1.75rem;font-weight:300}.mobile-nav-bar__submenu-items{margin-top:3rem;margin-bottom:3rem}.mobile-nav-bar__submenu-item{margin-bottom:0.25rem;display:block;font-size:0.88rem;--tw-text-opacity:1;color:rgb(255 255 255 / var(--tw-text-opacity));text-decoration-line:none}.mobile-nav-bar__newsletter{margin-bottom:2rem}.mobile-nav-bar__newsletter__header{margin-bottom:0.75rem;font-size:1.125rem;line-height:1.75rem;font-weight:300}.mobile-nav-bar__newsletter__input{display:flex;justify-content:space-between;padding-top:0.5rem;padding-bottom:0.5rem;border-bottom:1px solid #fff}.mobile-nav-bar__newsletter__input input{all:unset;flex-grow:1;font-size:0.88rem}.mobile-nav-bar__newsletter__input button{all:unset;cursor:pointer;padding-left:1rem;font-size:0.88rem}.mobile-nav-bar__links{margin-bottom:2rem;display:grid;grid-template-columns:repeat(2, minmax(0, 1fr));gap:1.5rem}.mobile-nav-bar__link-header{margin-bottom:0.75rem;font-size:1rem;line-height:1.5rem;font-weight:300}.mobile-nav-bar__link-item{display:block;font-size:12px;--tw-text-opacity:1;color:rgb(255 255 255 / var(--tw-text-opacity));text-decoration-line:none}.mobile-nav-bar__search{position:fixed;bottom:0px;left:0px;right:0px;display:flex;justify-content:space-between;--tw-bg-opacity:1;background-color:rgb(255 255 255 / var(--tw-bg-opacity));--tw-text-opacity:1;color:rgb(0 0 0 / var(--tw-text-opacity))}.mobile-nav-bar__search input{all:unset;display:block;width:100%;padding:1rem}.mobile-nav-bar__search button{all:unset;display:block;padding-left:3rem;padding-right:3rem;padding-top:1rem;padding-bottom:1rem;border-left:1px solid #888}";
...
let MobileNavBar = class {
  ...
  render() {
    return (h(Host, null, h("div", { class: "mobile-nav-bar", onClick: () => {
        // Scroll to the top of the page.
        window.scrollTo({ top: 0, behavior: 'smooth' });
      } }, h("div", { class: `mobile-nav-bar__icons ${this.isOpen ? 'mobile-nav-bar__icons--open' : ''}` }, h("div", { style: { display: 'flex', flexBasis: '0', flexGrow: '1', ridColumn: '2 span / 2 span' } }, this.isOpen ? (h("img", { class: "mobile-nav-bar__icon", src: getAssetPath('./assets/close.png'), alt: "Close Menu", style: { width: '0.88rem', height: '0.88rem' }, onClick: () => (this.isOpen = false) })) : (h("img", { class: "mobile-nav-bar__icon", src: getAssetPath('./assets/hamburger.png'), alt: "Open Menu", style: { width: '1.13rem', height: '1.13rem', marginLeft: '-0.13rem' }, onClick: () => (this.isOpen = true) }))), h("div", { style: {
        display: 'flex',
        justifyContent: 'center',
        fontSize: '12.5px',
        gridColumn: '4 span / 4 span',
        marginTop: '2px',
      } }, this.pageTitle.length >= 24 ? `${this.pageTitle.slice(0, 25)}...` : this.pageTitle), h("div", { style: { display: 'flex', justifyContent: 'flex-end' } }, h("a", { href: this.platformSpecificLink('store', '/cart') }, h("img", { class: "mobile-nav-bar__icon", src: getAssetPath('./assets/shopping-bag.png'), alt: "Cart", style: { paddingRight: '0.5rem' } })), h("a", { href: this.platformSpecificLink('blog', '/moods') }, h("img", { class: "mobile-nav-bar__icon", src: getAssetPath('./assets/user.png'), alt: "Account", style: { width: '0.9rem', height: '0.9rem', paddingLeft: '0.5rem' } })))), h("div", { ref: () => this.windowResizeEl, class: `mobile-nav-bar__menu ${this.isOpen ? 'mobile-nav-bar__menu--open' : ''}` }, h("div", null, h("img", { class: "mobile-nav-bar__logo", src: getAssetPath('./assets/leibal-logo.png'), alt: "Logo", style: { marginBottom: '3.5rem' }, onClick: () => {
