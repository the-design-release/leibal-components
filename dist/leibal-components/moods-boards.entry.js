...
const moodsBoardsCss = ":host{display:block}.moods-boards{display:block;cursor:default;font-size:0.88rem}@media (min-width: 768px){.moods-boards{display:grid}.moods-boards{grid-template-columns:repeat(10, minmax(0, 1fr))}.moods-boards{gap:1rem}.moods-boards__sidebar{grid-column:span 2 / span 2}}.moods-boards__content{display:block}@media (min-width: 768px){.moods-boards__content{grid-column:span 8 / span 8}.moods-boards__content{display:grid}.moods-boards__content{grid-template-columns:repeat(4, minmax(0, 1fr))}.moods-boards__content{gap:2rem}.moods-boards__content{row-gap:4rem}}.moods-boards__create-board{margin-bottom:0.5rem}.moods-boards__create-board__input{display:flex;align-items:center;padding-top:0.5rem;padding-bottom:0.5rem;border-bottom:1px solid #888}.moods-boards__create-board__input input{all:unset;flex:1 1 0%;cursor:text}.moods-boards__create-board__button{margin-left:0.5rem;display:flex;cursor:pointer;align-items:center}.moods-boards__create-board__button img{width:16px;opacity:0.7}.moods-boards__create-board a{display:block;padding-top:0.5rem;padding-bottom:0.5rem;font-weight:200}.moods-boards__create-board a:hover{cursor:pointer;font-weight:400;text-decoration-line:underline;text-underline-offset:2px}.moods-boards__sort__header{margin-bottom:0.5rem}.moods-boards__sort-by{margin-bottom:0.5rem;margin-left:1.5rem;cursor:pointer;font-weight:200}.moods-boards__sort-by--selected{font-weight:400;text-decoration-line:underline;text-underline-offset:2px}.moods-boards a{text-decoration-line:none;color:inherit}.moods-boards__preview{margin-bottom:4rem;display:block}@media (min-width: 768px){.moods-boards__preview{margin-bottom:0px}}";
