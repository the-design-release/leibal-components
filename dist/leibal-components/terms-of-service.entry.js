...
const termsOfServiceCss = ":host{display:block}.terms-of-service{display:block;font-size:13px;font-weight:300}@media (min-width: 768px){.terms-of-service{display:grid}.terms-of-service{grid-template-columns:repeat(10, minmax(0, 1fr))}.terms-of-service{gap:2rem}}.terms-of-service * button{all:unset;display:block;cursor:pointer}@media (min-width: 768px){.terms-of-service__sections{grid-column:span 2 / span 2}}.terms-of-service__sections>*{margin-bottom:0.5rem !important}.terms-of-service__section--active{font-weight:600 !important}.terms-of-service__subsection-select--active{font-weight:600 !important}.terms-of-service__subsections{margin-bottom:4rem}@media (min-width: 768px){.terms-of-service__subsections{grid-column:span 3 / span 3}.terms-of-service__subsections{margin-bottom:6rem}}.terms-of-service__subsections>*{margin-bottom:0.5rem !important}.terms-of-service__subheaders>*{margin-bottom:0.5rem !important}.terms-of-service__subheaders>*:hover{font-weight:600 !important}@media (min-width: 768px){.terms-of-service__content{grid-column:span 5 / span 5}}.terms-of-service__subsection__title{margin-bottom:1rem;font-size:1.875rem;line-height:2.25rem}.terms-of-service__subsection__content{padding-top:4rem}.terms-of-service__subsection__content__title{margin-bottom:2rem;font-size:1.125rem;line-height:1.75rem;font-weight:400}";
