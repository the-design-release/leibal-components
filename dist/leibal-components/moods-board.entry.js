...
const moodsBoardCss = ":host{display:block}.moods-board{display:block;cursor:default;font-size:13px}@media (min-width: 768px){.moods-board{display:grid}.moods-board{grid-template-columns:repeat(10, minmax(0, 1fr))}.moods-board{gap:1rem}.moods-board__sidebar{grid-column:span 2 / span 2}}.moods-board__contents{display:block;gap:2rem}@media (min-width: 768px){.moods-board__contents{grid-column:span 8 / span 8}.moods-board__contents{display:grid}.moods-board__contents{grid-template-columns:repeat(4, minmax(0, 1fr))}}.moods-board__contents{}.moods-board__content{margin-bottom:4rem;cursor:pointer}.moods-board__content__image{width:100%}.moods-board__content__title{margin-top:1rem;margin-bottom:0.25rem;font-size:9px;text-transform:uppercase}.moods-board__content__subtitle{font-size:9px;font-weight:300;text-transform:uppercase}.moods-board__create-board{margin-bottom:0.5rem;cursor:pointer;padding-top:0.5rem;padding-bottom:0.5rem}.moods-board__create-board:hover{font-weight:700;-webkit-text-decoration-line:underline;text-decoration-line:underline;text-underline-offset:2px}.moods-board__sort__header{margin-bottom:0.5rem}.moods-board__sort-by{margin-bottom:0.5rem;margin-left:1.5rem;cursor:pointer}.moods-board__sort-by--selected{font-weight:700;-webkit-text-decoration-line:underline;text-decoration-line:underline;text-underline-offset:2px}";
