...
const simpleInputCss = ":host{--font-family:var(--leibal-components-font-family, sans-serif);--color-light:#fff;--color-dark:#222;--color-gray:#ddd;font-family:var(--font-family);display:block}.simple-input{display:block}.simple-input--text{display:block;width:100%;padding-bottom:1rem;letter-spacing:0.05em;border:none;outline:none;border-bottom:1px solid var(--color-gray)}.simple-input--text::-moz-placeholder{font-weight:300;letter-spacing:0.05em;font-family:var(--font-family);opacity:1 !important;color:#999}.simple-input--text::placeholder{font-weight:300;letter-spacing:0.05em;font-family:var(--font-family);opacity:1 !important;color:#999}";
