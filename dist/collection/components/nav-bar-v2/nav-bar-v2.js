      ...
      h("div", { class: "container" },
        h("div", { class: "menu" },
          ...
          this.platform == 'blog' && (h(Fragment, null,
            ...
            h("div", { class: "master-link moods" }, this.authenticated ? (h("a", { href: this.platformSpecificLink('blog', '/moods') },
              h("img", { src: getAssetPath('./assets/moods.png'), alt: "MOODS" }))) : (h("a", { href: this.platformSpecificLink('blog', '/subscription/subscribe') }, "Sign Up"))))),
