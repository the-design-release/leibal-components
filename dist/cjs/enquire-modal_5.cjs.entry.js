...
let NavBarV2 = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "container" }, index.h("div", { class: "menu" }, index.h("div", { class: "logo" }, index.h("img", { src: index.getAssetPath('./assets/leibal-logo.png'), alt: "logo", onClick: () => {
      ...
      }, type: "text", placeholder: "Start Typing..." })))), index.h("div", { class: `menu submenu ${this.currentMenu == 'read' && 'submenu--open'}` }, index.h("div", null), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('blog', '/') }, "Read All")), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('blog', '/category/architecture') }, "Architecture")), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('blog', '/category/interiors') }, "Interiors")), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('blog', '/category/furniture') }, "Furniture")), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('blog', '/category/lighting') }, "Lighting")), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('blog', '/category/objects') }, "Objects")), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('blog', '/category/travel') }, "Travel")), index.h("div", { class: "sub-link inactive" }), index.h("div", null)), index.h("div", { class: `menu submenu ${this.currentMenu == 'shop' && 'submenu--open'}` }, index.h("div", null), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('store', '/collections/all') }, "Shop All")), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('store', '/collections/seating') }, "Seating")), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('store', '/collections/tables') }, "Tables")), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('store', '/collections/lighting') }, "Lighting")), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('store', '/collections/storage') }, "Storage")), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('store', '/collections/outdoor') }, "Outdoor")), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('store', '/collections/accessories') }, "Accessories")), index.h("div", { class: "sub-link" }), index.h("div", null)))));
  }
};
