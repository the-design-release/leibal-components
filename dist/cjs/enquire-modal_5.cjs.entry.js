...
const navBarV2Css = ":host{--font-family:var(--leibal-components-font-family,sans-serif);--color-white:#fff;--color-light:#f3f3f3;--color-dim:#ddd;--color-dark:#222;display:block;font-family:var(--font-family)}.container{left:0;position:fixed;right:0;top:0;-webkit-user-select:none;-moz-user-select:none;user-select:none;z-index:1000}.menu{grid-gap:2rem;background:var(--color-white);border-bottom:1px solid var(--color-dim);display:grid;grid-template-columns:repeat(10,1fr);height:4.375rem;padding:0 3.75rem;position:relative;z-index:1000}.logo{align-items:center;cursor:pointer;display:flex}.logo img{height:auto;width:100%;width:5.2rem}.master-link{align-items:center;color:#000;display:flex;font-size:.9375rem;font-style:normal;font-weight:300;letter-spacing:.09375rem;line-height:normal}.master-link:hover{cursor:pointer}.master-link--active{text-decoration:underline;text-decoration-color:var(--color-dim);text-decoration-thickness:.125rem;text-underline-offset:.25rem;text-underline-position:under}.master-link a{color:#000;text-decoration:none;text-decoration-thickness:1px;text-underline-position:under}.master-link a:hover{cursor:pointer;text-decoration:underline}.sub-link{align-items:center;color:#000;display:flex;font-size:.75rem;font-style:normal;font-weight:300;letter-spacing:.09375rem;line-height:normal;padding:1.81rem 0!important}.sub-link:active{text-decoration:underline;text-decoration-color:var(--color-dim);text-decoration-thickness:.125rem;text-underline-offset:.25rem;text-underline-position:under}.sub-link a{color:#000;text-decoration:none;text-decoration-thickness:1px;text-underline-position:under}.sub-link a:hover{cursor:pointer;text-decoration:underline}.sub-link .inactive{color:#aaa}.empty-space{grid-column:span 4/span 4}.search{align-items:center;background:var(--color-dark);border-left:1px solid var(--color-white);color:var(--color-white);display:flex;justify-content:center;position:relative;width:calc(100% + 3.75rem);z-index:2500}.submenu{left:0;position:fixed;right:0;transform:translateY(-100%);transition:transform .2s ease-in-out;z-index:100}.submenu--open{transform:translateY(0)}.search-bar{background:var(--color-dark);color:var(--color-white);left:0;position:fixed;right:0;transform:translateX(100%);transition:transform .3s ease-in-out;z-index:2000}.search-bar--open{transform:translateX(0)}.search-bar input{all:unset;border-left:1px solid #fff;display:block;padding-left:.5rem;width:100%}.search-bar input::-moz-placeholder{color:#fff;opacity:1}.search-bar input::placeholder{color:#fff;opacity:1}.search-bar-container{align-items:center;display:flex;grid-column:span 9/span 9;justify-content:center}";
...
let NavBarV2 = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "container" }, index.h("div", { class: "menu" }, index.h("div", { class: "logo" }, index.h("img", { src: index.getAssetPath('./assets/leibal-logo.png'), alt: "logo", onClick: () => {
        window.location.href = this.platformSpecificLink(this.platform, '/');
      } })), index.h("div", { class: `master-link ${this.currentMenu == 'read' && 'master-link--active'}`, onClick: () => {
        this.currentMenu = this.currentMenu == 'read' ? null : 'read';
      } }, "Read"), index.h("div", { class: `master-link ${this.currentMenu == 'shop' && 'master-link--active'}`, onClick: () => {
        this.currentMenu = this.currentMenu == 'shop' ? null : 'shop';
      } }, "Shop"), index.h("div", { class: "empty-space" }), this.platform == 'blog' && (index.h(index.Fragment, null, index.h("div", { class: "master-link" }, index.h("a", { href: "/submissions-form" }, "Submit")), index.h("div", { class: "master-link" }, this.authenticated ? (index.h("a", { href: this.platformSpecificLink('blog', '/moods') }, "MOODS")) : (index.h("a", { href: this.platformSpecificLink('blog', '/subscription/subscribe') }, "Sign Up"))))), this.platform == 'store' && (index.h(index.Fragment, null, index.h("div", { class: "master-link" }, index.h("a", { href: "https://leibal.com/info/#trades" }, "Trade")), index.h("div", { class: "master-link" }, index.h("a", { href: this.platformSpecificLink('store', `/cart`) }, "Cart")))), index.h("div", { class: "master-link search", onClick: () => {
        if (this.currentMenu != null)
          this.currentMenu = null;
        this.isSearchOpen = !this.isSearchOpen;
      } }, "Search"), index.h("div", { class: `menu search-bar ${this.isSearchOpen && 'search-bar--open'}` }, index.h("div", { class: "search-bar-container" }, index.h("input", { ref: el => (this.searchInput = el), class: "navbar__search__input", onInput: e => {
      ...
      }, type: "text", placeholder: "Start Typing..." })))), index.h("div", { class: `menu submenu ${this.currentMenu == 'read' && 'submenu--open'}` }, index.h("div", null), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('blog', '/') }, "Read All")), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('blog', '/category/architecture') }, "Architecture")), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('blog', '/category/interiors') }, "Interiors")), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('blog', '/category/furniture') }, "Furniture")), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('blog', '/category/lighting') }, "Lighting")), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('blog', '/category/objects') }, "Objects")), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('blog', '/category/travel') }, "Travel")), index.h("div", { class: "sub-link inactive" }, index.h("a", { href: "#" }, "City Guides")), index.h("div", null)), index.h("div", { class: `menu submenu ${this.currentMenu == 'shop' && 'submenu--open'}` }, index.h("div", null), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('store', '/') }, "Shop All")), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('store', '/collections/seating') }, "Seating")), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('store', '/collections/tables') }, "Tables")), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('store', '/collections/lighting') }, "Lighting")), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('store', '/collections/storage') }, "Storage")), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('store', '/collections/outdoor') }, "Outdoor")), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('store', '/collections/accessories') }, "Accessories")), index.h("div", { class: "sub-link" }, index.h("a", { href: this.platformSpecificLink('store', '/collections/brands') }, "Brands")), index.h("div", null)))));
  }
};
