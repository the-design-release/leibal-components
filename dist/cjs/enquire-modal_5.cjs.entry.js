...
let NavBarV2 = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "container" }, index.h("div", { class: "menu" }, index.h("div", { class: "logo" }, index.h("img", { src: index.getAssetPath('./assets/leibal-logo.png'), alt: "logo", onClick: () => {
      ...
      } }, "Shop"), index.h("div", { class: "empty-space" }), this.platform == 'blog' && (index.h(index.Fragment, null, index.h("div", { class: "master-link" }, index.h("a", { href: "/submissions-form" }, "Submit")), index.h("div", { class: "master-link moods" }, this.authenticated ? (index.h("a", { href: this.platformSpecificLink('blog', '/moods') }, index.h("img", { src: index.getAssetPath('./assets/moods.png'), alt: "MOODS" }))) : (index.h("a", { href: this.platformSpecificLink('blog', '/subscription/subscribe') }, "Sign Up"))))), this.platform == 'store' && (index.h(index.Fragment, null, index.h("div", { class: "master-link" }, index.h("a", { href: "https://leibal.com/info/#trades" }, "Trade")), index.h("div", { class: "master-link" }, index.h("a", { href: this.platformSpecificLink('store', `/cart`) }, "Cart")))), index.h("div", { class: "master-link search", onClick: () => {
...
let SimpleButton = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: 'simple-button ' +
        ...
        (this.transparentBackground ? 'simple-button--transparent' : ' '), role: "button", "aria-pressed": "false", tabindex: "0" }, index.h("div", { class: "simple-button__icon" }, index.h("slot", { name: "icon" })), index.h("div", { class: "simple-button__text" }, index.h("slot", null)))));
  }
};
