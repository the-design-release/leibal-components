...
let ImageGallery = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("tele-portal", null, index.h("div", { class: this.isModalOpen ? 'image-gallery image-gallery--visible' : 'image-gallery' }, index.h("div", { class: "image-gallery__info" }, index.h("div", { onClick: () => {
        this.isModalOpen = false;
      }, style: { position: 'relative' } }, index.h("div", { class: "image-gallery__info__title" }, this.postTitle), index.h("div", { class: "image-gallery__info__subtitle" }, "by ", this.postExcerpt), index.h("div", { class: "image-gallery__info__photographer__label" }, "Photography"), index.h("div", { class: "image-gallery__info__photographer__title" }, this.photographer), index.h("div", { class: "swiper-pagination" })), index.h("div", null, index.h("add-to-moods-button", { theme: 'dark', "image-url": this._images[this.currentImageIndex].href, "post-id": this.postId, "content-location": 'right', style: { margin: '2.5rem 0' } }, index.h("span", { style: { marginLeft: '1rem', fontSize: '0.75rem' } }, "Save Image to MOODS"))), index.h("div", null, this.canEnquire && (index.h("enquire-modal", { postTitle: this.postTitle + ' by ' + this.postExcerpt, previewImage: this.previewImage })), !this.canEnquire && designDetail && (index.h("div", null, index.h("div", { class: "image-gallery__info__subtitle" }, "Design Details"), index.h("div", { class: "block xl:grid xl:grid-cols-12 xl:gap-8" }, index.h("display-card", { images: JSON.stringify([designDetail.image.url]), style: { marginBottom: '0' }, class: "col-span-8" }, index.h("div", { slot: "top-title" }, designDetail.designer || 'Unknown'), index.h("div", { slot: "top-subtitle" }, designDetail.category || 'N/A'), index.h("div", { slot: "bottom-title" }, designDetail.name || ''), index.h("div", { slot: "bottom-subtitle" }, designDetail.price || '')), index.h("div", { class: "flex flex-col col-span-4 mb-8 text-2xs xl:mb-0" }, index.h("div", null, index.h("span", null, "As seen in image "), asSeenIns.map((image, i) => {
