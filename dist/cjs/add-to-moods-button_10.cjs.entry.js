...
let FooterNav = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: "footer-nav" }, index.h("div", { class: "footer-nav__column" }, index.h("div", { class: "footer-nav__title" }, "Stories"), index.h("div", { class: "footer-nav__links" }, index.h("a", { class: "footer-nav__link", href: this.platformSpecificLink('blog', '/category/architecture') }, "Architecture"), index.h("a", { class: "footer-nav__link", href: this.platformSpecificLink('blog', '/category/interiors') }, "Interiors"), index.h("a", { class: "footer-nav__link", href: this.platformSpecificLink('blog', '/category/furniture') }, "Furniture"), index.h("a", { class: "footer-nav__link", href: this.platformSpecificLink('blog', '/category/lighting') }, "Lighting"), index.h("a", { class: "footer-nav__link", href: this.platformSpecificLink('blog', '/category/products') }, "Products"), index.h("a", { class: "footer-nav__link", href: this.platformSpecificLink('blog', '/category/travel') }, "Travel"))), index.h("div", { class: "footer-nav__column" }, index.h("div", { class: "footer-nav__title" }, "Store"), index.h("div", { class: "footer-nav__links" }, index.h("a", { class: "footer-nav__link", href: this.platformSpecificLink('store', '/collection/seating') }, "Seating"), index.h("a", { class: "footer-nav__link", href: this.platformSpecificLink('store', '/collection/tables') }, "Tables"), index.h("a", { class: "footer-nav__link", href: this.platformSpecificLink('store', '/collection/lighting') }, "Lighting"), index.h("a", { class: "footer-nav__link", href: this.platformSpecificLink('store', '/collection/storage') }, "Storage"), index.h("a", { class: "footer-nav__link", href: this.platformSpecificLink('store', '/collection/outdoor') }, "Outdoor"), index.h("a", { class: "footer-nav__link", href: this.platformSpecificLink('store', '/collection/accessories') }, "Accessories"))), index.h("div", { class: "footer-nav__column" }, index.h("div", { class: "footer-nav__title" }, "About"), index.h("div", { class: "footer-nav__links" }, index.h("a", { class: "footer-nav__link", href: this.platformSpecificLink('blog', '/contact-us') }, "Contact Us"), index.h("a", { class: "footer-nav__link", href: this.platformSpecificLink('blog', '/submissions-form') }, "Submit"), index.h("a", { class: "footer-nav__link", href: this.platformSpecificLink('blog', '/faq') }, "FAQ"), index.h("a", { class: "footer-nav__link", href: this.platformSpecificLink('blog', '/privacy') }, "Privacy"), index.h("a", { class: "footer-nav__link", href: this.platformSpecificLink('blog', '/terms-and-conditions') }, "Terms & Conditions"), index.h("a", { class: "footer-nav__link", href: this.platformSpecificLink('blog', '/trades') }, "Trade Program"))), index.h("div", { class: "footer-nav__column" }, index.h("div", { class: "footer-nav__title" }, "Connect"), index.h("div", { class: "footer-nav__links" }, index.h("a", { class: "footer-nav__link", href: "https://www.pinterest.com/leibal/" }, "Pinterest"), index.h("a", { class: "footer-nav__link", href: "https://instagram.com/leibal" }, "Instagram"), index.h("a", { class: "footer-nav__link", href: "http://www.facebook.com/Leibal" }, "Facebook"), index.h("a", { class: "footer-nav__link", href: "https://leibal.tumblr.com/" }, "Tumblr"), index.h("a", { class: "footer-nav__link", href: "https://www.linkedin.com/company/leibal/" }, "LinkedIn"), index.h("a", { class: "footer-nav__link", href: "https://www.tiktok.com/leibal" }, "TikTok"))), index.h("div", { class: "footer-nav__column" }, index.h("div", { class: "footer-nav__title" }, "Newsletter"), index.h("div", { class: "footer-nav__email-form" }, this.platform === 'blog' ? blogNewsletterForm : storeNewsletterForm), index.h("div", { class: "footer-nav__trademark" }, "\u00A9 ", new Date().getUTCFullYear(), " LEIBAL LLC. ALL RIGHTS RESERVED")))));
  }
};
...
let ImageGallery = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("tele-portal", null, index.h("div", { class: this.isModalOpen ? 'image-gallery image-gallery--visible' : 'image-gallery' }, index.h("div", { class: "image-gallery__info" }, index.h("div", { onClick: () => {
        this.isModalOpen = false;
      }, style: { position: 'relative' } }, index.h("div", { class: "image-gallery__info__title" }, this.postTitle), index.h("div", { class: "image-gallery__info__subtitle" }, "by ", this.postExcerpt), index.h("div", { class: "image-gallery__info__photographer__label" }, "Photography"), index.h("div", { class: "flex justify-between items-center image-gallery__info__photographer__title" }, index.h("div", null, this.photographer), index.h("div", { class: "lg:hidden" }, index.h("add-to-moods-button", { theme: 'dark', "image-url": this._images[this.currentImageIndex].href, "post-id": this.postId, "content-location": 'left' }, index.h("span", { style: { marginRight: '0.5rem', fontSize: '0.5rem' } }, "Save Image to MOODS")))), index.h("div", { class: "swiper-pagination" })), index.h("div", { class: "hidden lg:block" }, index.h("add-to-moods-button", { theme: 'dark', "image-url": this._images[this.currentImageIndex].href, "post-id": this.postId, "content-location": 'right', style: { marginTop: '2.5rem' } }, index.h("span", { style: { marginLeft: '1rem', fontSize: '0.75rem' } }, "Save Image to MOODS"))), index.h("div", null, this.canEnquire && (index.h("div", { class: "hidden lg:block" }, index.h("enquire-modal", { postTitle: this.postTitle + ' by ' + this.postExcerpt, previewImage: this.previewImage }))), !this.canEnquire && designDetail && (index.h("div", { class: "hidden lg:block" }, index.h("div", { class: "image-gallery__info__subtitle" }, "Design Details"), index.h("div", { class: "block xl:grid xl:grid-cols-12 xl:gap-8" }, index.h("display-card", { images: JSON.stringify([designDetail.image.url]), style: { marginBottom: '0' }, class: "col-span-8" }, index.h("div", { slot: "top-title" }, designDetail.designer || 'Unknown'), index.h("div", { slot: "top-subtitle" }, designDetail.category || 'N/A'), index.h("div", { slot: "bottom-title" }, designDetail.name || ''), index.h("div", { slot: "bottom-subtitle" }, designDetail.price || '')), index.h("div", { class: "flex flex-col col-span-4 mb-8 text-2xs xl:mb-0" }, index.h("div", null, index.h("span", null, "As seen in image "), asSeenIns.map((image, i) => {
