...
let ImageGallery = class {
  ...
  componentDidLoad() {
    this.stopBodyScroll();
    this.swiper = new index$1.Swiper('.moods-gallery__images__swiper', DEFAULT_SWIPER_OPTIONS);
  ...
  render() {
    return (index.h(index.Host, null, index.h("tele-portal", null, index.h("div", { class: this.isModalOpen ? 'moods-gallery moods-gallery--visible' : 'moods-gallery' }, index.h("div", { class: "moods-gallery__info" }, index.h("div", { onClick: () => {
        location.href = this._images[this.currentImageIndex].postUrl;
      }, style: { position: 'relative', cursor: 'pointer' } }, index.h("div", { class: "moods-gallery__info__title" }, this.postTitle()), index.h("div", { class: "moods-gallery__info__subtitle" }, this.postExcerpt()), index.h("div", { class: "moods-gallery__info__photographer__label" }, "Photography"), index.h("div", { class: "moods-gallery__info__photographer__title" }, this.photographer()), index.h("div", { class: "swiper-pagination" }))), index.h("div", { class: "moods-gallery__images" }, index.h("div", { class: "swiper moods-gallery__images__swiper" }, index.h("div", { class: "swiper-wrapper" }, this._images.map(image => (index.h("div", { class: "swiper-slide" }, index.h("img", { src: image.imageUrl }))))), index.h("div", { class: "swiper-button-next" }), index.h("div", { class: "swiper-button-prev" })), index.h("div", { class: "moods-gallery__images__close", onClick: () => {
        this.isModalOpen = false;
      } }, "Close"))))));
  }
...
ImageGallery.style = moodsGalleryCss;

exports.moods_gallery = ImageGallery;
