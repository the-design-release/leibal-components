...
let NavBar = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { style: { height: (this.scrolled ? this.currentHeight : 0) + 'px' } }), index.h("nav", { class: 'navbar ' + (this.scrolled ? 'navbar--scrolled ' : '') + (this.scrolledUp ? 'show' : '') }, index.h("div", { class: "navbar__row" }, index.h("a", { href: this.platformSpecificLink('blog', '/'), class: 'navbar__row__leading navbar__row__leading__logo ' + (this.platform === 'blog' ? 'font-bold' : '') }, index.h("div", { class: "navbar__logo" }, index.h("img", { src: index.getAssetPath(`./assets/leibal-logo.png`) })), index.h("a", { href: "/" }, "Stories")), index.h("div", { class: "navbar__row__links" }, index.h("a", { href: this.platformSpecificLink('blog', '/category/architecture') }, "Architecture"), index.h("a", { href: this.platformSpecificLink('blog', '/category/interiors') }, "Interiors"), index.h("a", { href: this.platformSpecificLink('blog', '/category/furniture') }, "Furniture"), index.h("a", { href: this.platformSpecificLink('blog', '/category/lighting') }, "Lighting"), index.h("a", { href: this.platformSpecificLink('blog', '/category/products') }, "Objects"), index.h("a", { href: this.platformSpecificLink('blog', '/category/travel') }, "Travel")), index.h("div", { class: "navbar__row__action" }, index.h("a", { href: "/submissions-form" }, "Submit"), this.authenticated ? (index.h("a", { href: this.platformSpecificLink('blog', '/moods'), class: "navbar__moods-logo" }, index.h("img", { src: index.getAssetPath(`./assets/moods-white.png`) }))) : (index.h("a", { href: this.platformSpecificLink('blog', '/subscription/subscribe') }, "Sign Up")))), index.h("div", { class: "navbar__row" }, index.h("div", { class: 'navbar__search ' + (this.showSearch ? 'navbar__search--visible' : '') }, index.h("input", { ref: el => (this.searchInput = el), class: "navbar__search__input", onInput: e => {
      ...
      }, type: "text", placeholder: "Start Typing..." })), index.h("a", { href: this.platformSpecificLink('store', '/'), class: 'navbar__row__leading ' + (this.platform === 'store' ? 'font-bold' : '') }, index.h("div", { class: "navbar__logo", style: { opacity: '0', visibility: 'hidden' } }, index.h("img", { src: index.getAssetPath(`./assets/leibal-logo.png`) })), "Store"), index.h("div", { class: "navbar__row__links" }, index.h("a", { href: this.platformSpecificLink('store', '/collections/seating') }, "Seating"), index.h("a", { href: this.platformSpecificLink('store', '/collections/tables') }, "Tables"), index.h("a", { href: this.platformSpecificLink('store', '/collections/lighting') }, "Lighting"), index.h("a", { href: this.platformSpecificLink('store', '/collections/storage') }, "Storage"), index.h("a", { href: this.platformSpecificLink('store', '/collections/outdoor') }, "Outdoor"), index.h("a", { href: this.platformSpecificLink('store', '/collections/accessories') }, "Accessories")), index.h("div", { class: "navbar__row__action" }, index.h("a", { href: this.platformSpecificLink('store', '/cart'), class: "border-l border-white cursor-pointer" }, "Cart"), index.h("a", { class: "z-10 cursor-pointer", onClick: () => {
